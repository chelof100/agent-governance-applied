...
We answer that question empirically and with a specific claim: \emph{none of
the three failure modes above survives when the complete governance stack is
operating.}
...
The results are unambiguous within our experimental setup: the stack closes the gap.
