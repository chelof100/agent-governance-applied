...
\caption{Experiment~1b: $\widehat{D}_t$ from mistral-small3.1 (solid black)
vs.\ the MockLLM baseline from Exp.\,1 seed~42 (dashed gray). Bottom panel
shows the tool selected at each step -- the shift from \texttt{read\_file}
to \texttt{write\_data}, \texttt{delete\_record}, and \texttt{admin\_action}
is contextually driven, not probabilistically forced. Detection threshold
$\theta=0.20$ crossed at $T^*=64$.}
\label{fig:exp1b}
\end{figure}
