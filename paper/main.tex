...
This is Paper~7 of the Agent Governance Series (P0--P7; Paper~8 on scale and heterogeneity is in preparation).
\end{abstract}
...
\textbf{Scale and heterogeneity (Paper~8 scope).}
...
persistent side-effects, and long-horizon tasks introduce failure modes
beyond this paper's scope: correlated drift across agents, emergent
coordination patterns not reducible to round-robin interleaving, and
recovery loops operating on shared rather than agent-local state.
These constitute the empirical program for Paper~8 of the series.
